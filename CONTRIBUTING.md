...
<p align="center">
    RAW Light Simulation reader/converter
</p>
...
Note that the **yapf** package is used during build process of **rawls** package to format the whole code following these conventions.
...
This command do a lot of thing for you:
  ...
  - Formats all **\*.py** inside *rawls* folder using **yapf**.
